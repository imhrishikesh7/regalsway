  ...
  return (
    ...
    <div className="container mt-5">
      ...
      <ol className="text-justify">
        ...
        <li>
          In this regard, SEBI had cautioned investors against dealing with such unregulated platforms offering algorithmic trading services/strategies vide Press Release No. 20/2022 dated June 10, 2022.
        </li>
        <li>
          It has also come to notice of SEBI that stock brokers provide algorithmic trading facility to investors through such platforms.
        </li>
        <li>
          ...
          <br />
          (4.1) Stock Brokers who provide services relating to algorithmic trading shall not:
          <br />
          (4.1.1.) directly or indirectly make any reference to the past or expected future return/performance of the algorithm; and/or
          <br />
          (4.1.2.) directly or indirectly associate with any platform providing any reference to the past or expected future return/performance of the algorithm
          <br />
        ...
        <li>
          Stock exchanges are hereby directed to:
          <br />
          (5.1) take necessary steps and put in place necessary systems and procedures for implementation of the above provisions;
          <br />
          (5.2) make necessary amendments to the relevant bye-laws, rules, and regulations for the implementation of the above provisions;
          <br />
          (5.3) bring the provisions of this circular to the notice of stock brokers and disseminate the same on their website;
          <br />
        ...
        <li>
          Appropriate action may be taken by SEBI under the securities laws for noncompliance of the above provisions.
        </li>
        <li>
